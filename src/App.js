        ...
        {showSearchPage ? (
          <div className="search-books">
            <div className="search-books-bar">
              <a href="#href" className="close-search" onClick={() => setShowSearchPage({ showSearchPage: false })}>Close</a>
          ...
          <div className="list-books">
            ...
            <div className="open-search">
              <a href="#href" onClick={() => setShowSearchPage({ showSearchPage: true })}>Add a book</a>
            </div>
          </div>
        )}
      </div>
